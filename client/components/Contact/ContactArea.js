                              ...
                              <li>
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       <h4>VIT Vellore</h4>
                                       <p><a target="_blank" rel="noreferrer" href="https://www.google.com/maps/place/Vellore+Institute+of+Technology/@12.9692232,79.1559336,15z/data=!4m2!3m1!1s0x0:0xfef222e5f36ecdeb?sa=X&ved=2ahUKEwjFor7T8b_6AhUCTWwGHY6xD-AQ_BJ6BAhrEAU">VIT - Vellore Campus, Tiruvalam Road, Katpadi, Vellore, Tamil Nadu</a></p>
                              ...
                              <li>
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       ...
                                       <p><a href="mailto:support@careercare.com">support@careercare.com</a></p>
                                       <p><a href="mailto:info@careercare.com"> info@careercare.com</a></p>
                                    </div>
                                 </div>
                              </li>
                              <li>
                                 <div className="contact__info-item d-flex align-items-start mb-35">
                                    ...
                                    <div className="contact__info-text">
                                       <h4>Phone</h4>
                                       <p><a href="tel:+(426)-742-26-44">+91 91234 56789</a></p>
                                       <p><a href="tel:+(224)-762-442-32">+91 91234 56798</a></p>
                                    </div>
                                 </div>
                              </li>
                           </ul>
