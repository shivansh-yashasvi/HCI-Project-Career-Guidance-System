...
const CourseSidebarArea = () => {
  ...
  return (
    <>
      <section className="course__area pt-50 pb-90 grey-bg-3">
                        ...
                        <div className="row">

                          {
                            courseItems.map(course => {
                              const { _id, img_bg, category, title, enrolled, watching, review, url } = course;
                      ...
                      <div className="tab-pane fade" id="list" role="tabpanel" aria-labelledby="list-tab">
                        <div className="row">
                          <div className="col-xxl-12">
                            {
                              courseItems.map(course => {
                                const { _id, img_bg, category, title, lessons, url } = course;
