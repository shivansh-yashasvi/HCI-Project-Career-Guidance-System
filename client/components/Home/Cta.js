...
const Cta = () => {
   return (
      <>
         <section className="cta__area pt-50 pb-50">
                  ...
                  <div className="row">
                     <div className="col-xxl-6 col-xl-6 col-lg-6">
                        <div className="cta__item cta__item-border pt-40 pb-15 d-sm-flex align-items-start pr-110">
                           ...
                           <div className="cta__content">
                              ...
                              <p>Teach what you love. Get in contact with us and we will add your courses to our database.</p>
                              <Link href="/contact">
                     ...
                     <div className="col-xxl-6 col-xl-6 col-lg-6">
                        <div className="cta__item pl-85 pt-40 pb-15 d-sm-flex align-items-start">
                           ...
                           <div className="cta__content">
                              <h3 className="cta__title">Upskill yourself</h3>
                              <p>Profile Completed ? Then its time to jump in and improve your skills.</p>
                              <Link href="/course-sidebar">
                                 <a className="tp-btn tp-btn-4">View Courses</a>
                              </Link>
                           </div>
                        </div>
                     </div>
