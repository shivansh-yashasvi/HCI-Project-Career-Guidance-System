...
const LoginArea = () => {
   ...
   return (
      <>
         ...
         <section className="signup__area p-relative z-index-1 pt-20 pb-50">
            <div className="sign__shape">
               <img className="man-1" src="assets/img/icon/sign/man-1.png" width={400} alt="" />
               <img className="man-2" src="assets/img/icon/sign/man-2.png" width={400} alt="" />
               <img className="circle" src="assets/img/icon/sign/circle.png" width={50} alt="" />
                     ...
                     <div className="sign__wrapper white-bg">
                        ...
                        <div className="sign__form">
                           <form onSubmit={handleSubmit(onSubmit)}>
                              ...
                              <button className="tp-btn  w-100 mt-20"> <span></span> Sign In</button>
